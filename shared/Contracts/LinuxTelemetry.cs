...
/// <summary>Stable platform value used by Linux-only v2 contracts.</summary>
...
public static class TelemetrySourceKinds
{
    ...
    public static bool IsValidForPlatform(string? sourceKind, string? platform) => sourceKind switch
    {
        ...
        InventoryDiff or AgentHealth => platform == TelemetryPlatforms.Linux,
        _ => false
    };
}
...
/// <summary>Canonical deterministic identity operations for Linux v2 events.</summary>
