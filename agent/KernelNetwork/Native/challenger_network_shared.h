...
#define CHALLENGER_FLOW_MAP_ENTRIES 262144
#define CHALLENGER_TRACKED_FLOW_ENTRIES 524288
#define CHALLENGER_OWNER_MAP_ENTRIES 32768
#define CHALLENGER_RING_BYTES (32 * 1024 * 1024)
#define CHALLENGER_MAX_KERNEL_DRAIN_RECORDS 32768
#define CHALLENGER_MAX_OUTPUT_RECORDS 4096
...
#define CHALLENGER_MAX_KERNEL_RECORDS_PER_HEALTH_INTERVAL \
    (CHALLENGER_MAX_KERNEL_DRAIN_RECORDS * CHALLENGER_HEALTH_INTERVAL_SECONDS)
