...
builder.Services.AddSingleton<LinuxPackageJournalEvidenceTracker>();
...
builder.Services.AddSingleton<LinuxPackageInventoryDiffStateStore>();
builder.Services.AddSingleton<LinuxPackageInventoryDiffRuntime>();
builder.Services.AddSingleton<ILinuxAcknowledgementObserver>(services => services.GetRequiredService<LinuxPackageInventoryDiffRuntime>());
builder.Services.AddSingleton<ILinuxInventoryObserver>(services => services.GetRequiredService<LinuxPackageInventoryDiffRuntime>());
