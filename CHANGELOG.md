...
- Added generalized Windows/Linux asset and host-detail workflows with platform/freshness/coverage/source/pressure/gap/capacity filtering, explicit source applicability and health guidance, queue/resource/source rate/lag/checkpoint plus retention/capacity visibility, bounded role-redacted inventory/posture changes, additive telemetry-coverage fields, synthetic tests, and no host-policy mutation actions.
