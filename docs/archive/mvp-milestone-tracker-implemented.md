# Archived: MVP milestone tracker

> Archived after implementation. The original MVP checklist below has been superseded by the current milestone status in `docs/milestones.md`.
